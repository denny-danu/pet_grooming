	...
	<header class="portal-header">
		<div class="portal-header-container">
			...
			<div class="portal-header-right">
				...
				<a href="/login" class="staff-console-link" title="Staff Management Console">
					<User size={14} />
						...
						<div class="step-card">
							...
							{:else}
								<div class="dates-row">
									...
									<div class="form-group">
										<label>{page.data.locale === "id" ? "Pilih Jam" : "Select Time Slot"}</label>
						...
						<div class="step-card">
							...
							<div class="sub-form-section">
								...
								<div class="form-row">
									...
									<div class="form-group">
										<label>{page.data.locale === "id" ? "Jenis / Spesies" : "Species"}</label>
										<div class="species-select-grid">
	...
	<footer class="portal-footer">
		<div class="footer-container">
			...
			<div class="footer-links">
				<a href="/book">{page.data.locale === "id" ? "Reservasi Online" : "Online Booking"}</a>
